 ...
 *
 *
 * @package    propel.generator.Orm.Zed.Availability.Persistence.Base
 */
abstract class SpyAvailabilityAbstract implements ActiveRecordInterface
{
    ...
    public function setIdAvailabilityAbstract($v)
    {
        ...
        if ($this->id_availability_abstract !== $v) {
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyAvailabilityAbstractTableMap::translateFieldName('AbstractSku', TableMap::TYPE_PHPNAME, $indexType)];
            $this->abstract_sku = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyAvailabilityAbstractTableMap::translateFieldName('Quantity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quantity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyAvailabilityAbstractTableMap::translateFieldName('FkStore', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setAbstractSku($arr[$keys[1]]);
        }
