...
class SpyAvailabilityAbstractTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Orm.Zed.Availability.Persistence.Map.SpyAvailabilityAbstractTableMap';
     ...
     */
    public const CLASS_DEFAULT = 'Orm.Zed.Availability.Persistence.SpyAvailabilityAbstract';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAvailabilityAbstract', 'AbstractSku', 'Quantity', 'FkStore', ],
        self::TYPE_CAMELNAME     => ['idAvailabilityAbstract', 'abstractSku', 'quantity', 'fkStore', ],
        self::TYPE_COLNAME       => [SpyAvailabilityAbstractTableMap::COL_ID_AVAILABILITY_ABSTRACT, SpyAvailabilityAbstractTableMap::COL_ABSTRACT_SKU, SpyAvailabilityAbstractTableMap::COL_QUANTITY, SpyAvailabilityAbstractTableMap::COL_FK_STORE, ],
        self::TYPE_FIELDNAME     => ['id_availability_abstract', 'abstract_sku', 'quantity', 'fk_store', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAvailabilityAbstract' => 0, 'AbstractSku' => 1, 'Quantity' => 2, 'FkStore' => 3, ],
        self::TYPE_CAMELNAME     => ['idAvailabilityAbstract' => 0, 'abstractSku' => 1, 'quantity' => 2, 'fkStore' => 3, ],
        self::TYPE_COLNAME       => [SpyAvailabilityAbstractTableMap::COL_ID_AVAILABILITY_ABSTRACT => 0, SpyAvailabilityAbstractTableMap::COL_ABSTRACT_SKU => 1, SpyAvailabilityAbstractTableMap::COL_QUANTITY => 2, SpyAvailabilityAbstractTableMap::COL_FK_STORE => 3, ],
        self::TYPE_FIELDNAME     => ['id_availability_abstract' => 0, 'abstract_sku' => 1, 'quantity' => 2, 'fk_store' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setPackage('Orm.Zed.Availability.Persistence');
